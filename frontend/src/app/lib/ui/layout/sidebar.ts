...
export class SidebarGroupLabelComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(sidebarGroupLabelVariants({ collapsed: this.collapsed() }), this.class())
  );
}
...
export class SidebarHeaderComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(sidebarHeaderVariants({ collapsed: this.collapsed() }), this.class())
  );
}
...
export class SidebarFooterComponent {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(sidebarFooterVariants({ collapsed: this.collapsed() }), this.class())
  );
}
